export function controller() {
    ...
    const eliminarFotoDlg = document.querySelector('#eliminarFotoDlg')
    const btnEliminarFoto = document.querySelector('#btnEliminarFoto')
    const btnCancelEliminarFoto = document.querySelector('#btnCancelEliminarFoto')
    ...
    btnEliminarFoto.addEventListener('click', onClickDlgEliminar)
    btnCancelEliminarFoto.addEventListener('click', onClickDlgEliminar)
    ...
    function renderFotos() {
        ...
        aBtnBorrar.forEach( item => item.addEventListener('click', dlgEliminar))
    }
    ...
    function dlgEliminar() {
        eliminarFotoDlg.showModal()
    }

    function onClickDlgEliminar(ev) {
        let id = ev.target.id 
        if (id == 'btnEliminarFoto') {
            itemActual =  ev.target.dataset.idDb
            let url = URL + `/${itemActual}`
